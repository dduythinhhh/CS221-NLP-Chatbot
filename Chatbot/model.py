...
# Thêm dấu
corrector = pipeline("text2text-generation", model="ThuyNT03/CS221_DT_bartpho-add-accent")
...
chat = ChatOpenAI(openai_api_key="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")
chat_plus = ChatOpenAI(openai_api_key="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", model='gpt-3.5-turbo-0125')
...
def Chatbot(query):
  ...
  if Cls_in_out(query, model_cls_in_out, vectorizer_in_out) == 1:
    print(Cls_in_out(query, model_cls_in_out, vectorizer_in_out))
